...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="glasso, glass, gifts, love, beautiful, simple , shining, laravel, laravel 5, laravel 5.2" />
        <meta name="author" content="Prateek Kumar Goel" />
        <link rel="shortcut icon" href="/images/slider/fav-icon.png" />

        <title>Glasso | Home</title>
...
<body>
    ...
    <!-- MDB core JavaScript -->
    <script type="text/javascript" src="/js/libs/mdb.js"></script>
    <!-- Include sweet-alert.js file -->
    <script type="text/javascript" src="/js/libs/sweetalert.js"></script>
    <!-- Include typeahead.js file -->
    <script type="application/javascript" src="/js/libs/typeahead.js"></script>
    <!-- Include lity light-box js file -->
    <script type="application/javascript" src="/js/libs/lity.js"></script>
    <!-- Stripe.js file -->
    ...
    <script>
        // your publish key
        Stripe.setPublishableKey('pk_test_Hxw8wQ4KSVim7e7Mt5ggcT1g');
        //
        jQuery(function($) {
